...
def sorted_polygon(poly):
    '''
    helper func for bounded_noisy_polygons(). The polygon returned form the noisy finite polygons might not be sorted (dots changing sequence locally
    which will return an error for intersection method.
    '''
